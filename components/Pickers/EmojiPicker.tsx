      ...
      `}>
                ...
                <div className={styles.emojiGrid} ref={emojiRef}>
                    {currentCategory === 'people' && (
                        <People data={peopleList} handleClick={handleClick} />
                    )}

                    {currentCategory === 'animals' && (
                        <Animals data={natureList} handleClick={handleClick} />
                    )}

                    {currentCategory === 'food' && (
                        <Food data={foodList} handleClick={handleClick} />
                    )}

                    {currentCategory === 'objects' && (
                        <Objects data={objectList} handleClick={handleClick} />
                    )}

                    {currentCategory === 'symbols' && (
                        <Symbols data={symbolList} handleClick={handleClick} />
                    )}
