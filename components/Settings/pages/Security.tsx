        ...
        <div className={styles.pageContainer}>
            ...
            <div className={styles.settings}>
                <div className={styles.option}>
                    <h5><span><MdPassword/></span> Password</h5>
                ...
                <div className={styles.option}>
                    <h5><span><MdShield/></span> Use two-factor authentication</h5>
                    <p>A code will be sent to your gmail to confirm your identity every time you log in</p>
