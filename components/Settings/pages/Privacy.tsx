        ...
        <div className={styles.pageContainer}>
            ...
            <div className={styles.settings}>
                <div className={styles.option}>
                    <h5><span><IoPersonCircleSharp/></span> Account Type</h5>
                    <p>Public (everyone can see your posts)</p>
                    <button>Edit</button>
                </div>
                <div className={styles.option}>
                    <h5><span><AiOutlineMail/></span> Who can send you friend requests?</h5>
                    <p>Everyone</p>
                    <button>Edit</button>
                </div>
                <div className={styles.option}>
                    <h5><span><BsFillPeopleFill/></span> Who can see your friends?</h5>
                    <p>Only Friends</p>
                    <button>Edit</button>
                </div>
                <div className={styles.option}>
                    <h5><span><BiMessageSquareDetail/></span> Who can send you messages?</h5>
                    <p>Only Friends</p>
                    <button>Edit</button>
                </div>
            </div>
