        ...
        <div className={styles.galleryColumnContainer}>
            <div className={styles.uploadForm}>
                <form onSubmit={handleSubmit}>
                    ...
                    <label className={styles.label} htmlFor="file"><span><MdInsertPhoto/></span>Choose a photo</label>
                    {error &&  <div className={styles.error}>
                        <span>{error}</span>
                    </div>}
                    {
                        file && <div className={styles.inputContainer}>
                            <Input 
                                type='text'
                                label="Image Title"
                                name="title" 
                    ...
                    {file && <div className={styles.imagePreview}>
                        <imgPreview file={file} setFile={setFile}/>
                    </div>}
                    <button 
                    className={`${styles.button} ${file && title && styles.active}`} 
                    type="submit"
                    ><span><MdFileUpload/></span>Upload</button>
                    { isLoading &&
